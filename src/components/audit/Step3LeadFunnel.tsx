import {
  FormField, StepHeader, StyledSelect, MultiCheckbox, StepProps
} from "./AuditFormComponents";

const HS_LEAD_SOURCES = [
...
const HS_RESPONSE_SPEEDS = [...RESPONSE_SPEEDS, "No consistent process"];
const RE_RESPONSE_SPEEDS = [...RESPONSE_SPEEDS, "It depends on the agent"];
...
const REVIEWS_COUNT = ["0–25", "26–50", "51–100", "101–250", "250+"];

const REVIEW_AUTOMATION = [
  "Yes — automated via software", "Yes — manually ask sometimes", "No",
];

const RE_REVIEW_AUTOMATION = [
