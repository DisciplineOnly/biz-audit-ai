...
const BG_LABELS: Record<string, string> = {
  ...
  "Automated follow-up sequence (thank you + review request + maintenance reminder)": "Автоматизирана последователност (благодарност + заявка за отзив + напомняне за поддръжка)",
  ...
  "Automated follow-up sequence": "Автоматизирана последователност за проследяване",
  ...
  // RE Post-close
  "Automated post-close nurture sequence": "Автоматизирана последователност след приключване",
  ...
  // RE Referral
  "Yes — automated asks at key milestones": "Да — автоматизирани заявки при ключови етапи",
