...
export const BG_SUB_NICHE_OPTIONS: Record<SubNicheGroup, SubNicheOptions> = {
  ...
  reactive: {
    ...
    kpis: [
      "Средна стойност на поръчка/задача",
      "Процент поправка от първия път",
      "Процент обратни обаждания/преработки",
      "Приход на техник",
      "Процент резервирани от запитвания",
      "Брой членства/сервизни планове",
      "Оценка на удовлетвореност на клиентите",
      "Време за реакция при спешно обаждане",
      "Маржове на печалба по тип задача",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  recurring: {
    ...
    kpis: [
      "Процент задържане на абонаменти",
      "Процент отлив на клиенти",
      "Приход на маршрут/екипаж",
      "Месечен рекурентен приход (MRR)",
      "Средна стойност на абонамент",
      "Цена за привличане на клиент",
      "Процент навременно завършване",
      "Разход за материали на задача",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  project_based: {
    ...
    kpis: [
      "Средна стойност на проект",
      "Процент приети оферти",
      "Брутен марж на проект",
      "Спазване на бюджета (CPI)",
      "Изпълнение на графика (SPI)",
      "Производителност на труда",
      "Процент рекламации/гаранционни искове",
      "Стойност на портфейла от проекти",
      "Съотношение фактурируеми часове",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  residential_sales: {
    ...
    kpis: [
      "Генерирани лийдове на агент",
      "Уговорени срещи на агент",
      "Процент на конверсия (лийд → клиент)",
      "Средно дни до приключване",
      "Цена на лийд по източник",
      "GCI на агент",
      "Оценка на удовлетвореност на клиентите",
      "Средно съотношение обявена/продажна цена",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  commercial: {
    ...
    kpis: [
      "Приключени сделки на тримесечие",
      "Общо наета площ (кв.м.)",
      "Средна стойност на наем/комисиона",
      "Стойност на Pipeline",
      "Среден цикъл на сделка",
      "Комисиона на сделка",
      "Процент задържане на наематели",
      "Проучвателна активност на брокер",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  property_management: {
    ...
    kpis: [
      "Процент заетост",
      "Средно дни до повторно отдаване",
      "Процент събираемост на наеми",
      "Време за решаване на заявки за поддръжка",
      "Процент подновяване на наеми",
      "Ръст на управлявани обекти",
      "Нетен оперативен приход (NOI) на имот",
      "Процент задържане/отлив на собственици",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  new_construction: {
    ...
    kpis: [
      "Продадени обекти на месец",
      "Процент конверсия на предварителни резервации",
      "Средно време от резервация до договор",
      "Цена на кв.м. спрямо пазарен бенчмарк",
      "Процент сделки чрез ко-оп брокери",
      "Маркетинг разход на продаден обект",
      "Процент анулирания/възстановявания",
      "Не проследяваме никакви KPI",
    ],
  },
  ...
  luxury_resort: {
    ...
    kpis: [
      ...
      "Съотношение международни/местни купувачи",
      "Време на пазара за луксозни обяви",
      "Процент сключване от квалифицирани показвания",
      "Процент препоръки/повторни клиенти",
      "Средна комисиона на сделка",
      "Квалифицирани представяния на купувачи на месец",
      "Не проследяваме никакви KPI",
    ],
  },
};
